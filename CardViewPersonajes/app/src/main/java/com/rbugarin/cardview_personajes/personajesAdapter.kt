...
class personajesAdapter (private val personajes : List<Personaje>): RecyclerView.Adapter<personajesAdapter.PersonajeHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PersonajeHolder {
        ...
        val view = layoutInflater.inflate(R.layout.card_personajes, parent, false)
